...
partial class CSharpSyntaxAnalysisNodeCreator
{
    public abstract class SyntaxRootViewNodeCreator<TValue>(CSharpSyntaxAnalysisNodeCreator creator)
        : RootViewNodeCreator<TValue, CSharpSyntaxAnalysisNodeCreator>(creator)
    {
    ...
    public sealed class SyntaxTreeRootViewNodeCreator(CSharpSyntaxAnalysisNodeCreator creator)
